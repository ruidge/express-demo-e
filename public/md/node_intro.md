...
本地安装 : npm install <pkg> 安装到当前目录(node_modules) <br/>
全局安装 : npm install -g <pkg> 安装到全局目录. <br/>
package.json :  npm install <pkg> --save 本地安装的同时保存到package.json, 项目所有依赖包统一管理.使用的时候调用npm install即可讲所有包都安装(node_modules)
